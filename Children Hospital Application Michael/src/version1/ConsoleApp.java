...
public class ConsoleApp {
	...
	public static void main(String[] args) {
		...
		Patient patient1 = new Patient ("Michael", "Nguyen", Person.Gender.MALE, LocalDate.of(1998, 06, 17), parent1, Insurance.ASSURA);

		Parent parent2 = new Parent("Sarah", "Lobsiger", Person.Gender.FEMALE, "132456789", "3000 Bern");
		Patient patient2 = new Patient("Lars", "Meyer", Person.Gender.MALE, LocalDate.of(2010, 12, 31), parent2, Insurance.KPT);
		
		Pediatrition pediatrition1 = new Pediatrition("Adrian", "Casty", Person.Gender.MALE, Pediatrition.Title.Dr_Med);
		Pediatrition pediatrition2 = new Pediatrition("Heinni", "Hans", Person.Gender.MALE, Pediatrition.Title.Prof_Dr);
		...
		Vaccination vaccination1 = new Vaccination(Vaccination.Vaccine.TETANUS, pediatrition1);
		Vaccination vaccination2 = new Vaccination(Vaccination.Vaccine.COVID, pediatrition2);
