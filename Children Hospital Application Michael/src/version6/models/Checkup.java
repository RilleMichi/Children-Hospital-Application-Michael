...
public class Checkup {public Checkup() {
	...
	public String toString() {
	  ...
	  public String toCSV() {
	    return this.checkupDate + "," + this.height + "," + this.weight + "," + this.temperature + "," + this.covid19 + "," + this.patientNumber;
	  }
	  
	  public static Checkup fromCSV(String csv) {
	    ...
	    int patientNumber = Integer.parseInt(fields[5]);
	    
	    //Null für Pediatricion
	    return new Checkup(weight, height, temperature, covidTest, checkupDate, null ,patientNumber);
	  }
