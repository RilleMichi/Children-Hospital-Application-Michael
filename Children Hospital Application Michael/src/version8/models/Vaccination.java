...
public class Vaccination {
	...
	public Vaccination(Vaccine vaccine, Pediatrician pediatrician, int patientNumber) {
		this.date = LocalDate.now();
		this.vaccine = vaccine;
		this.pediatrician = pediatrician;
	...
	public Vaccination(Vaccine vaccine, LocalDate localDate, Pediatrician pediatrician, int patientNumber) {
		this.date = localDate;
		this.vaccine = vaccine;
		this.pediatrician = pediatrician;
		this.patientNumber = patientNumber;
	...
	public String toString() {
		return String.format("{Date: %s, Vaccine: %s, Patientnumber: %s}", this.date, this.vaccine, this.patientNumber);
	}
